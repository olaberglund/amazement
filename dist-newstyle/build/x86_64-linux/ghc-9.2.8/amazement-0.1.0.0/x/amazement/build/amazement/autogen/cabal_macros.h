...
/* package amazement-0.1.0.0 */
#ifndef VERSION_amazement
#define VERSION_amazement "0.1.0.0"
#endif /* VERSION_amazement */
#ifndef MIN_VERSION_amazement
#define MIN_VERSION_amazement(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_amazement */
...
#define TOOL_VERSION_alex "3.2.7.3"
...
#define CURRENT_COMPONENT_ID "amazement-0.1.0.0-inplace-amazement"
